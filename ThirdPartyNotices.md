ThirdPartyNotices
-----------------
SMS uses third-party software or other resources that
may be distributed under licenses different from SMS
software.
...
--------------------------------------------------------------------------------
Apache License 2.0 (Commons IO, JSON-Simple,
Maven, MojoHaus Flatten Maven Plugin,
